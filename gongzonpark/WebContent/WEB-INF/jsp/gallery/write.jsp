			...
			<div class="container">
				...
				<form method="post" class="form-group m-0" enctype="multipart/form-data">
					<div class="portfolio-description pt-0">
						...
						<input type="text" name="title" class="form-control mt-2 mb-3" placeholder="제목을 30자 이내로 입력하세요." id="galleryTitle" />
						<label for="galleryContent">내용</label>&nbsp;&nbsp;&nbsp;<span class="text-muted small" id="contentCount"></span>
						<textarea name="content" rows="10" class="form-control mb-3" placeholder="내용를 입력하세요." id="galleryContent" ></textarea>
						<label>첨부파일</label>
						<div class="fileInput">
					...
					<div class="row">
						<div class="col-lg-12 d-flex justify-content-end">
							<button class="portfolio-button-bottom mr-2" id="btnWriteGallery"><i class="far fa-save"></i> 등록</button>
							<button class="portfolio-button-bottom" id="btnCancleWriteGallery" onclick="cancleWriteGallery()"><i class="fas fa-times"></i> 취소</button>
							<div class="modal fade" id="cancleWriteGalleryModal">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-info" onclick="btnGalleryList()">목록</button>
...
<script>
	...
	$(function() {
		...
		// 글 작성
		$("#btnWriteGallery").click(function() {
	...
	// 글 작성 취소
	function cancleWriteGallery() {
		event.preventDefault();
		$("#cancleWriteGalleryModal").modal();
	}
	// 글 작성 취소 시 모달창의 목록버튼
	function btnGalleryList() {
		event.preventDefault();
